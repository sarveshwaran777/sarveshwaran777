...
<div align="center">
  <h1>👋 Hey there, I'm Sarveshwaran M!</h1>
  <p align="center">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00F2FE&center=true&vCenter=true&width=600&lines=Electrical+%26+Electronics+Engineering+Student;AI+%26+IoT+Solutions+Developer;Embedded+Systems+%26+Robotics+Enthusiast;Full+Stack+Web+Developer" alt="Typing SVG" />
  </p>
  <p align="center">
    <a href="https://github.com/sarveshwaran777">
      <img src="https://komarev.com/normal-gradient.png?username=sarveshwaran777&color=00f2fe&style=flat-square&label=Profile+Views" alt="Profile Views" />
    </a>
  </p>
</div>
...
* 🤝 Actively seeking opportunities for **internships, hackathons, and collaborative projects**
...
*   [View Project →](https://github.com/sarveshwaran777/AI-Supply-Chain-Guardian)

### 🏭 FactoryOps AI
An AI assistant tailored for manufacturing operations, utilizing telemetry feeds from assembly lines to perform real-time anomaly detection and predictive maintenance.
*   **Tech Stack:** FastAPI, React, SQLite
*   [View Project →](https://github.com/sarveshwaran777/FactoryOps-AI)

### 🧹 DUSTRIX CleanBot Pro
An autonomous smart floor-cleaning robot. Features microcontrollers programmed for sensor integration, obstacle avoidance, and path optimization.
*   **Tech Stack:** C, Arduino, Firebase
*   [View Project →](https://github.com/sarveshwaran777/DUSTRIX-CleanBot-Pro)

### 🚨 Smart Emergency Response System
An IoT-enabled platform connecting sensor nodes across industrial environments to detect emergencies (gas leaks, fires) and automate alert dispatches.
*   **Tech Stack:** Python, Arduino, Firebase
*   [View Project →](https://github.com/sarveshwaran777/Smart-Emergency-Response-System)

### ⚡ Power Quality Monitoring System
A smart telemetry system that monitors real-time voltage, current, and power factor parameters to identify grid faults and optimize energy efficiency.
*   **Tech Stack:** C, React, Arduino
...
*   🏅 **Hackathon Finalist** – Competed and excelled in national-level technical hackathons, creating software/hardware prototypes.
*   🤖 **AI & IoT Projects** – Built intelligent end-to-end setups leveraging edge computing, sensor fusion, and cloud telemetry.
*   🏭 **Industry 4.0 Solutions** – Developed digital twin components and anomaly detection models for factory floor optimization.
*   🔌 **Embedded Systems Development** – Designed and programmed microcontrollers, automated cleaning bots, and telemetry devices.
...
<div align="center">
  <a href="https://github.com/sarveshwaran777" target="_blank">
...
<p align="center">
  <i>Designed with ⚡ and 💻 by Sarveshwaran M.</i>
</p>
